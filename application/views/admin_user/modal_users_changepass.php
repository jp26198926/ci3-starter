	    	...
	    	<div class="modal-content">
	      		...
	      		<div class="modal-body">	        		
	        		<div class="row" style="margin-bottom: 0.5em;">				        
						<div class="col-sm-12">
				            ...
				            <input type="password" id="txt_changepass_password" class="field_users form-control" />
				        </div>
					</div>
					<div class="row" style="margin-bottom: 0.5em;">	
						<div class="col-sm-12">
				            <label>ReType Password *</label>
				            <input type="password" id="txt_changepass_repassword" class="field_users form-control" />
				        </div>
				    </div>					
	      		...
	      		<div class="modal-footer">
	      			...
	      			<div class="pull-right modal_button">
						<button type="button" id="btn_changepass_save" class="btn btn-info" ><span class='fa fa-check'></span> Save </button>
