									...
									<h1>
										...
										<div class="input-group pull-right" style='width: 15em;'>											
											...
											<span class="input-group-btn">
												<button id='btn_module_search' class="btn btn-sm btn-primary" type="button" title='Search Module' data-toggle='tooltip'>
													<i class="ace-icon fa fa-search bigger-110"></i>
													Go!
												</button>
												<button id='btn_module_new' class="btn btn-sm btn-success" type="button" title='New Module' data-toggle='tooltip'>
			...
			$(document).on("click","#btn_common_password_update",function(e){
				...
				if (id && oldpassword && password && repassword){
					if (password == repassword){
						...
						$.post("model/db_user_common.php",{action:1, id:id, oldpassword:oldpassword,
